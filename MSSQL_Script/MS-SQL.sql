...
create table employee(
	ENO int not null CONSTRAINT PK_EMP PRIMARY KEY,
	 ENAME VARCHAR(10),
 	 JOB   VARCHAR(9),
	 MANAGER  int,
	 HIREDATE DATE,
...
(7369,'SMITH','CLERK',    7902,convert(date ,'1980-12-17'),800,NULL,10);
INSERT INTO EMPLOYEE VALUES
...
/*
	MS-SQL , MSSQL은 자동 커밋 트랜잭션 : commit 이 자동처리됨 
